...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{matrot}\mathrel{=}\alt{\Varid{nil}}{\mathsf{conc}}\comp \Varid{recList}\;(\Varid{matrot})\comp \Varid{recList}\;(\Varid{rotate})\comp \Varid{outList}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{matrot}\mathrel{=}\Varid{f}\comp \Varid{recList}\;(\Varid{matrot})\comp \Varid{g}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}{}\<[E]%
\\
...
&
    \ensuremath{\mathrm{1}} + \ensuremath{\Conid{A}}^* \times {\ensuremath{\Conid{A}}^*}^*
           \ar[d]^{\ensuremath{\Varid{recList}\;\anaList{\Varid{g}}}}
\\
     {\ensuremath{\Conid{A}}^*}^*
...
&
     \ensuremath{\mathrm{1}} + \ensuremath{\Conid{A}}^* \times {\ensuremath{\Conid{A}}^*}^*
           \ar[d]^-{\ensuremath{\Varid{recList}\;\llparenthesis\, \Varid{f}\,\rrparenthesis}}
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{reverse\char95 gen}\mathbin{::}()+(\Varid{a2},[\mskip1.5mu \Varid{a2}\mskip1.5mu])\to [\mskip1.5mu \Varid{a2}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{reverse\char95 gen}\mathrel{=}\alt{\Varid{nil}}{\mathsf{conc}\comp \Varid{swap}\comp (\Varid{singl}\times\Varid{id})}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{transpose\char95 gen}\mathbin{::}[\mskip1.5mu [\mskip1.5mu \Varid{a1}\mskip1.5mu]\mskip1.5mu]\to ()+([\mskip1.5mu \Varid{a1}\mskip1.5mu],[\mskip1.5mu [\mskip1.5mu \Varid{a1}\mskip1.5mu]\mskip1.5mu]){}\<[E]%
\\
...
Podemos definir a função para o exercício e a função auxiliar que vai fazer esta junção das listas, este \ensuremath{\Varid{replaceWhen}}, da seguinte maneira:
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{replaceWhenf}\mathbin{::}(\Varid{a}\to \Conid{Bool})\to ([\mskip1.5mu \Varid{a}\mskip1.5mu],[\mskip1.5mu \Varid{a}\mskip1.5mu])\to [\mskip1.5mu \Varid{a}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{replaceWhenf}\;\Varid{f}\mathrel{=}\alt{\Varid{g}}{\Varid{h}}\comp \Varid{alpha}{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
...
\>[20]{}\conj{\p1\comp \p2}{(\Varid{replaceWhenf}\;\Varid{f})\comp \conj{\p2\comp \p1}{\p2\comp \p2}}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
\>[11]{}\Varid{false'}\mathrel{=}\conj{\p1\comp \p1}{(\Varid{replaceWhenf}\;\Varid{f})\comp \conj{\p2\comp \p1}{\Varid{cons}\comp \conj{\p1\comp \p2}{\p2\comp \p2}}}{}\<[E]%
\\
\>[5]{}\hsindent{6}{}\<[11]%
...
\\
\>[B]{}\Varid{relativeFrequence}\;\Varid{l}\mathrel{=}\map \;(\Varid{id}\times(((\mathbin{/}\Varid{fromIntegral}\;\Varid{s})\comp \Varid{fromIntegral})))\;\Varid{mset}\;\mathbf{where}\;(\Varid{mset},\Varid{s})\mathrel{=}\Varid{msetplus}\;\Varid{l}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{mkdist}\mathbin{::}\Conid{Eq}\;\Varid{a}\Rightarrow [\mskip1.5mu \Varid{a}\mskip1.5mu]\to \fun{Dist}\;\Varid{a}{}\<[E]%
\\
...
Apartir dai a \ensuremath{\Varid{mkdist}}, utilizando a \ensuremath{\Varid{mkD}}, gera nos a distribuição de ocorrências dos valores.
...
A partir da \ensuremath{\Varid{groupBy}} e da utilização da funlão anónima \ensuremath{\lambda \Varid{x}\;\Varid{y}\to \p1\;\Varid{x}\equiv \p1\;\Varid{y}}, vamos agrupar os dados pelo seu segmento.
De seguida, utilizamos o \ensuremath{\conj{\p1\comp \Varid{head}}{\Varid{mkdist}\comp (\map \;\p2)}} para criar os pares \ensuremath{(\Conid{Segment},\fun{Dist}\;\Conid{Delay})}. 
Sendo, assim vamos ter então a nossa \ensuremath{\Conid{DB}}.
...
% no código seguinte.
Utilizando a nossa \ensuremath{\Conid{DB}}, conseguimos definir a nossa função \ensuremath{\Varid{delay}}.
...
Através da utilização da função \ensuremath{\Varid{mkf}} na \ensuremath{\Conid{DB}}, obtemos a distribuição do segmento que procuramos. 
Utilizando a função \ensuremath{\Varid{outMaybe}} definida na Cp.hs e o \ensuremath{\alt{\cdot }{\cdot }} que ocorre após a mesma, conseguimos ter a distribuição do segmento.
...
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{path}\mathbin{::}\Conid{Stop}\to \Conid{Stop}\to [\mskip1.5mu \Conid{Segment}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{path}\;\Varid{s1}\;\Varid{s2}\mathrel{=}[\mskip1.5mu (\Varid{s},\succ \;\Varid{s})\mid \Varid{s}\leftarrow [\mskip1.5mu \Varid{s1}\mathinner{\ldotp\ldotp}\Varid{pred}\;\Varid{s2}\mskip1.5mu]\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{unit}\mathbin{::}\fun{Dist}\;\Conid{Delay}{}\<[E]%
\\
\>[B]{}\Varid{unit}\mathrel{=}\Varid{mkD}\;[\mskip1.5mu (\mathrm{0},\mathrm{1})\mskip1.5mu]{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{lDelay}\mathbin{::}[\mskip1.5mu \Conid{Segment}\mskip1.5mu]\to \fun{Dist}\;\Conid{Delay}{}\<[E]%
\\
\>[B]{}\Varid{lDelay}\;(\Varid{h}\mathbin{:}\Varid{t})\mathrel{=}(\Varid{joinWith}\;(\mathbin{+})\;(\Varid{lDelay}\;(\Varid{t}))\comp \Varid{delay})\;\Varid{h}{}\<[E]%
\\
\>[B]{}\Varid{lDelay}\;\anonymous \mathrel{=}\Varid{unit}{}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{f}\mathbin{::}[\mskip1.5mu \Conid{Segment}\mskip1.5mu]\to \fun{Dist}\;\Conid{Delay}{}\<[E]%
\\
\>[B]{}\Varid{f}\mathrel{=}\llparenthesis\, \alt{\underline{\Varid{unit}}}{{}\<[36]%
\>[36]{}\Varid{aux}}\,\rrparenthesis{}\<[E]%
\\
\>[B]{}\hsindent{5}{}\<[5]%
\>[5]{}\mathbf{where}\;\Varid{aux}\mathrel{=}\uncurry{(\Varid{joinWith}\;(\mathbin{+}))}\comp (\Varid{delay}\times\Varid{id}){}\<[E]%
\\[\blanklineskip]%
\>[B]{}\Varid{pdelay}\mathbin{::}\Conid{Stop}\to \Conid{Stop}\to \fun{Dist}\;\Conid{Delay}{}\<[E]%
\\
\>[B]{}\Varid{pdelay}\mathrel{=}\overline{\cdot }\mathbin{\$}\Varid{f}\comp \uncurry{\Varid{path}}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
