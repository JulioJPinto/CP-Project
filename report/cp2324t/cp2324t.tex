...
\>[B]{}\Varid{ex1pw}\mathbin{::}[\mskip1.5mu [\mskip1.5mu \Varid{a}\mskip1.5mu]\mskip1.5mu]\to [\mskip1.5mu \Varid{a}\mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{ex1pw}\;[\mskip1.5mu \mskip1.5mu]\mathrel{=}[\mskip1.5mu \mskip1.5mu]{}\<[E]%
\\
\>[B]{}\Varid{ex1pw}\;(\Varid{h}\mathbin{:}\Varid{t})\mathrel{=}\Varid{h}\mathbin{+\!\!+}\Varid{ex1}\;(\Varid{reverse}\;(\Varid{transpose}\;\Varid{t})){}\<[E]%
\ColumnHook
...
\column{B}{@{}>{\hspre}l<{\hspost}@{}}%
\column{E}{@{}>{\hspre}l<{\hspost}@{}}%
\>[B]{}\Varid{ex1}\mathrel{=}\alt{\Varid{nil}}{\mathsf{conc}}\comp \Varid{recList}\;(\Varid{ex1}\comp \Varid{reverse}\comp \Varid{transpose})\comp \Varid{outList}{}\<[E]%
\ColumnHook
\end{hscode}\resethooks
